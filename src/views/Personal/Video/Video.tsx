...
const Video: React.FC = () => {
  ...
  const [popVis, setPopVis] = React.useState(false)
  const {
  ...
  return (
    <Layout style={{ overflow: "auto", backgroundColor: "white" }}>
      <MySide setPopVis={setPopVis}></MySide>
      <Popup visible={popVis} switchVis={handleSwitchPop}></Popup>
      <Layout style={{ backgroundColor: "white", overflow: "auto" }}>
        ...
        >
          ...
          <div>
            ...
            <Button type="primary" style={{ margin: "0 10", fontSize: "12px" }} onClick={() => changeRoute(true)}>
              创建视频
            </Button>
          </div>
        </Header>
