...
const Customize = () => {
  ...
  const [audioTitle, setAudioTitle] = React.useState<string>('')
  const { uploadAudio, setUploadAudio } = useDesignEditorContext()
  ...
  const handleDropFiles = async (files: FileList) => {
    ...
    if (res && res.data && res.data.id) {
      setAudioTitle(res.data.filename_download)
      setUploadAudio(`${BACK_API_ASSETS}${res.data.id}`)
    }
  }
    ...
    <Block $style={{ flex: 1, display: "flex", flexDirection: "column" }}>
      ...
      <Scrollable>
        <Block padding="0 1.5rem">
          ...
          <Block padding={"0"} margin={"40px 0 0"}>
            <Button
            ...
            >
              <audio controls style={{ width: "260px" }} src={uploadAudio}></audio>
              <p style={{ margin: '10px' }}>{audioTitle}</p>
            </div>
          </Block>
        </Block>
      </Scrollable>
    ...
    <>
      ...
      >
        <Block $style={{ padding: "0 1.5rem", width: "640px" }}>
          ...
          >
            <Tab title="系统预设">
              <Block $style={{ width: "100%", height: "200px" }}>
                <Scrollbar>
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            src={BackgroundImg}
                          />
                          <span className="huabu_span">{sampleFrame.cnname}</span>
                        </Block>
